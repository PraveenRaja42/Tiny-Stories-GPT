...
block_size = 64  # 128 # what is the maximum context length for predictions?
max_iters = 2000  # 5000
eval_interval = 500
learning_rate = 3e-4
...
torch.save(model.state_dict(), r"gpt_1_50000.pth")
open('generated.txt', 'w').write(
    enc.decode(m.generate(context, max_new_tokens=10000)[0].tolist()))
