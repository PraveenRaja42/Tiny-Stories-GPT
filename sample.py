...
import tiktoken
import time
# from story_gpt_colab import GPTLanguageModel
...
class GPTLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        per_token_time = total_time / idx.size(1)
        print(f"Total generation time: {total_time:.4f} seconds")
        print(f"Per-token generation time: {per_token_time:.6f} seconds")
...
# m.load_state_dict(torch.load(r'./story_gpt_1_2000.pth'))
m.load_state_dict(torch.load(r'./story_gpt_1_2000.pth'))
m.eval()
print("model loaded...")

# Set the initial context for generation
text = "\n"  # "!"  # "Vinay was trying to catch a lion."
