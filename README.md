...
python gpt.py
```
You can change the dataset, hyperparameters, and save directory as you wish. After training, the generated text is printed and saved to the generated.txt file.
...
## Model Architecture
The model is an autoregressive decoder-only Transformer model which consists of the following components:
